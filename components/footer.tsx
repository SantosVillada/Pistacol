...
export default function Footer() {
  return (
    <footer className="bg-[#152a15] text-white" role="contentinfo">
      {/* Main footer content */}
      <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        {/* Links */}
        <div>
          <h3 className="text-[#e2c265] font-bold text-xs tracking-widest uppercase mb-5">
            Enlaces
          </h3>
            ...
            <ul className="space-y-3">
              {navLinks.map((link) => (
                <li key={link.href}>
                  <a
                    href={link.href}
                    className="text-[#a8c0a0] hover:text-[#e2c265] text-sm transition-colors"
                  >
                    {link.label}
                  </a>
                </li>
        ...
        <div>
          ...
          <ul className="space-y-4">
            <li>
              <p className="text-[#e2c265] text-xs font-bold uppercase tracking-wide mb-1">San Juan</p>
              <a
                href="https://wa.me/542644588978"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 text-[#a8c0a0] hover:text-[#e2c265] text-sm transition-colors"
              >
                <WhatsAppIcon />
                264 458 8978
              </a>
            ...
            <li>
              <p className="text-[#e2c265] text-xs font-bold uppercase tracking-wide mb-1">Córdoba</p>
              <a
        ...
        <div>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 text-[#a8c0a0] hover:text-[#e2c265] text-sm transition-colors mb-8"
          ...
          <h3 className="text-[#e2c265] font-bold text-xs tracking-widest uppercase mb-4">
            Certificaciones
          </h3>
      ...
      <div className="border-t border-[#c9a227]/15">
        <div className="max-w-7xl mx-auto px-6 py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-[#5a7a5a] text-xs text-center sm:text-left">
            © 2024 Pistacol · Todos los derechos reservados
          </p>
